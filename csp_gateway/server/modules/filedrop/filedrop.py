...
class ReadFileDropConfiguration(BaseModel):
    ...
    filedrop_type: FileDropType | str = Field(description="The type of files to expect and accordingly read i.e. parquet, json, etc")
    ...
    loader: Callable[[str], list[Any]] | None = Field(default=None, description="custom loader for loading files into list of struct like data")
    deserializer: Callable[[Any], Any] | None = Field(default=None, description="deserialize each data point to data type expected by channel type")
